...
import com.hljcj.acts.utils.test.acts.constant.AnsiColorConstants;
...
public class LogUtil {
     ...
     * @param message
     */
    public static void printColoredError(Logger log, String message) {
     ...
     * @param message
     */
    public static void printColoredInfo(Logger log, String message) {
        if (ActsConfiguration.getInstance().isColoredLog()) {
            String tmp = replaceCrLf(message);
