 ...
 */
package com.hljcj.acts.utils.test.acts.cache;

import com.hljcj.acts.utils.test.acts.constant.ActsPathConstants;
import com.hljcj.acts.utils.test.acts.constant.ActsYamlConstants;
...
public class ActsCacheData {
    ...
    public static void loadDataSet() {
        ...
        if (msgConfigData == null || msgConfigData.isEmpty()) {
            return;
        }
