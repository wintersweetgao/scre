...
import com.hljcj.acts.utils.test.acts.util.DateUtil;
...
public class DateTypeGenerator implements ObjectGenerator {
    ...
    private static final Logger LOG           = LogManager.getLogger(DateTypeGenerator.class);
    ...
    public Object generateFieldObject(Class<?> clz, String fieldName, String referedCSVValue) {
       Assert.assertEquals( clz, Date.class,"Date is is required!");
        Date retDate = null;
