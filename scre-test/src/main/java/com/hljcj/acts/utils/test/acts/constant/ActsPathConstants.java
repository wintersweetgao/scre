 ...
 */
package com.hljcj.acts.utils.test.acts.constant;

/**
 * The constants associated with the Acts path
 * 
 * @author baishuo.lp
 * @version $Id: ActsPathConstants.java, v 0.1 2015年8月13日 下午7:20:22 baishuo.lp Exp $
 */
