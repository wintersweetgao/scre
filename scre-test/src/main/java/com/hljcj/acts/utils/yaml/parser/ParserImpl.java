 ...
 */
package com.hljcj.acts.utils.yaml.parser;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

import com.hljcj.acts.utils.yaml.DumperOptions.Version;
import com.hljcj.acts.utils.yaml.error.Mark;
import com.hljcj.acts.utils.yaml.error.YAMLException;
import com.hljcj.acts.utils.yaml.events.AliasEvent;
import com.hljcj.acts.utils.yaml.events.DocumentEndEvent;
import com.hljcj.acts.utils.yaml.events.DocumentStartEvent;
import com.hljcj.acts.utils.yaml.events.Event;
import com.hljcj.acts.utils.yaml.events.ImplicitTuple;
import com.hljcj.acts.utils.yaml.events.MappingEndEvent;
import com.hljcj.acts.utils.yaml.events.MappingStartEvent;
import com.hljcj.acts.utils.yaml.events.ScalarEvent;
import com.hljcj.acts.utils.yaml.events.SequenceEndEvent;
import com.hljcj.acts.utils.yaml.events.SequenceStartEvent;
import com.hljcj.acts.utils.yaml.events.StreamEndEvent;
import com.hljcj.acts.utils.yaml.events.StreamStartEvent;
import com.hljcj.acts.utils.yaml.nodes.Tag;
import com.hljcj.acts.utils.yaml.reader.StreamReader;
import com.hljcj.acts.utils.yaml.scanner.Scanner;
import com.hljcj.acts.utils.yaml.scanner.ScannerImpl;
import com.hljcj.acts.utils.yaml.tokens.AliasToken;
import com.hljcj.acts.utils.yaml.tokens.AnchorToken;
import com.hljcj.acts.utils.yaml.tokens.BlockEntryToken;
import com.hljcj.acts.utils.yaml.tokens.DirectiveToken;
import com.hljcj.acts.utils.yaml.tokens.ScalarToken;
import com.hljcj.acts.utils.yaml.tokens.StreamEndToken;
import com.hljcj.acts.utils.yaml.tokens.StreamStartToken;
import com.hljcj.acts.utils.yaml.tokens.TagToken;
import com.hljcj.acts.utils.yaml.tokens.TagTuple;
import com.hljcj.acts.utils.yaml.tokens.Token;
import com.hljcj.acts.utils.yaml.util.ArrayStack;
