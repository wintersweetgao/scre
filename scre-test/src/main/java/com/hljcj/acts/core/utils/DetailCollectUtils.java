 ...
 */
package com.hljcj.acts.core.utils;
...
public class DetailCollectUtils {
    /* log* */
    private static final Logger log = LogManager.getLogger(DetailCollectUtils.class);
     ...
     * @param log the log
     */
    public static void appendAndLog(String content, Logger log) {
        log.info(content);
        sb.append(content);
        sb.append("\r\n");
    }
     ...
     * @param log the log
     */
    public static void appendAndLogColoredInfo(String content, Logger log) {
     ...
     * @param log the log
     */
    public static void appendAndLogColoredError(String content, Logger log) {
