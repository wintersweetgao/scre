 ...
 */
package com.hljcj.acts.core.collector.sqllog;
...
public class SqlLogParseFactory {
    ...
    /* log* */
    private static final Logger log = LogManager.getLogger(SqlLogParseFactory.class);
    ...
    public static VirtualTable genVirtualTable(String sqlType, List<String> sqlExecLog) {
        ...
        if (fieldsFlag == null || fieldsFlag.isEmpty()) {
