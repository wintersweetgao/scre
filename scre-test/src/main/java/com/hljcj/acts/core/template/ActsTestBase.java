 ...
 */
package com.hljcj.acts.core.template;

import com.alipay.test.acts.model.PrepareData;
import com.hljcj.acts.core.annotation.ActsAnnotationFactory;
import com.hljcj.acts.core.annotation.IActsMethod;
import com.hljcj.acts.core.annotation.TestBean;
import com.hljcj.acts.core.annotation.acts.*;
import com.hljcj.acts.core.collector.CaseResultCollector;
import com.hljcj.acts.core.collector.sqllog.SqlLogCollector;
import com.hljcj.acts.core.component.components.ActsComponentUtil;
import com.hljcj.acts.core.component.db.DBDatasProcessor;
import com.hljcj.acts.core.component.event.EventContextHolder;
import com.hljcj.acts.core.component.handler.TestUnitHandler;
import com.hljcj.acts.core.exception.ActsTestException;
import com.hljcj.acts.core.utils.AnnotationUtils;
import com.hljcj.acts.core.utils.CaseResultCollectUtil;
import com.hljcj.acts.core.utils.DetailCollectUtils;
import com.hljcj.acts.core.utils.ObjectUtil;
import com.hljcj.acts.core.runtime.ActsRuntimeContext;
import com.hljcj.acts.core.runtime.ActsRuntimeContextThreadHold;
import com.hljcj.acts.utils.test.acts.util.BaseDataUtil;
import com.hljcj.acts.core.utils.config.ConfigrationFactory;
...
public class ActsTestBase extends AbstractTestNGSpringContextTests {
    protected final static Logger log              = LogManager.getLogger(ActsTestBase.class);

    /*** sql log **/
    private static final Logger              sqlLog           = LogManager.getLogger("acts-sql-logger");
    ...
    public Iterator<Object[]> getDataProvider(Method method) throws IOException {
        try {
            ...
            log.error("getDataProvider方法抛出异常", e);
            throw new RuntimeException(e);
        }
    }
    ...
    protected void collectCaseResult() {
        try {
            if (ActsRuntimeContextThreadHold.getContext() == null) {
                log.warn("Can not write result!Because actsRuntimeContext is null.");
                return;
            }
