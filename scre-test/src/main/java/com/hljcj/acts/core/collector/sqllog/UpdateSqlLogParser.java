...
public class UpdateSqlLogParser implements SqlLogParser {
    ...
    /**
     * @see com.alipay.test.acts.collector.sqllog.SqlLogParser#parseTableName(String)
     */
    @Override
    ...
    /**
     * @see com.alipay.test.acts.collector.sqllog.SqlLogParser#parseTableFlags(String, Set)
     */
    @Override
